"""
Django settings for nilton_pimentel project.
...
DEV_APPS = ['django_extensions'] if DEBUG else []
...
ROOT_URLCONF = 'nilton_pimentel.urls'
...
WSGI_APPLICATION = 'nilton_pimentel.wsgi.application'
